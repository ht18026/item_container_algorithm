"""
    The program 5 handles the looting aspect of the adventure game Robbie is coding up
"""
...
class Magic_Multi_Container(Multi_Container):
    """
        ...
        is only the empty weight of itself
    """
    def __init__(self, name: str, multi_container: "Multi_Container") -> None:
        """
...
def read_magic_multi_containers() -> None:
    """
        reads the magic_multi_containers.csv and creates magic_multi_container objects
        for each magic_multi_container read in the csv
        Input: None
        Output: None 
    """
